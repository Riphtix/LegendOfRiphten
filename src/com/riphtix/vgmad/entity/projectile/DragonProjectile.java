...
public class DragonProjectile extends Projectile {
	 ...
	 * @param item
	 */
	public DragonProjectile(double x, double y, double dir, Item item) {
		...
		//speed = FAST_SPEED;
		damage = 20;
		sprite = Sprite.rotate(Sprite.dragonBlastSprite, angle);
